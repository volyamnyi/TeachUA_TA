...
public class GmailContentExtractor {
    ...
    public static HashMap<String, String> getGmailData(String query) {
        try {
            ...
            String bodyBase64 = jp.getString("payload.body.data");
            String body = new String(Base64.getUrlDecoder().decode(bodyBase64));//new String(Base64.getDecoder().decode(bodyBase64));
            String link = null;
    ...
    public static String getGmailMessageLink(String query){
        HashMap<String, String> hm = getGmailData(query);
        return hm.get("link");
    }

    /*public static void main(String[] args) throws IOException, GeneralSecurityException {
        HashMap<String, String> hm = getGmailData("subject:Відновлення паролю");
